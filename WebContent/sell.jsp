...
<body>
	...
	<form action="checkSellFields.jsp" method="POST">
		<div>
			<p>Item Type:</p>
			<input type="radio" name="itemType" id="itemTypeShoes" value="shoes"
				onclick="radio();" required /> <label for="itemType1">Shoes</label>
			<br> <input type="radio" name="itemType" id="itemTypeShirts"
				value="shirts" onclick="radio();" required /> <label for="itemType2">Shirts</label>
			<br> <input type="radio" name="itemType" id="itemTypePants"
				value="pants" onclick="radio();" required /> <label for="itemType3">Pants</label>
			<br>
			<table>
				<tr id="shoeRow" style="visibility: hidden">
					<td><label for="shoeBrand">Brand:</label> <input type="text"
						name="shoeBrand" id="shoeBrand" /></td>
					<td><label for="shoeSize">Size:</label> <input type="number"
						step="1" min="1" name="shoeSize" id="shoeSize" /></td>
					<td><label for="shoeColor">Color:</label> <input type="text"
						name="shoeColor" id="shoeColor" /></td>
				</tr>
				<tr id="shirtRow" style="visibility: hidden">
					<td><label for="shirtStyle">Style:</label> <input type="text"
						name="shirtStyle" id="shirtStyle" /></td>
					<td><label for="shirtSize">Size:</label> <input type="text"
						name="shirtSize" id="shirtSize" /></td>
					<td><label for="shirtFabric">Fabric:</label> <input
						type="text" name="shirtFabric" id="shirtFabric" /></td>
				</tr>
				<tr id="pantRow" style="visibility: hidden">
					<td><label for="pantBrand">Brand:</label> <input type="text"
						name="pantBrand" id="pantBrand" /></td>
					<td><label for="pantSize">Size:</label> <input type="number"
						step="1" min="1" name="pantSize" id="pantSize" /></td>
					<td><label for="pantFabric">Fabric:</label> <input type="text"
						name="pantFabric" id="pantFabric" /></td>
				</tr>
			</table>
		</div>
		<label for="itemName">Item Name:</label> <input type="text"
			name="itemName" id="itemName" required /> <br>
		<br> <label for="initialPrice">Initial Price:</label> <input
			type="number" step="0.01" min="0" name="initialPrice"
			id="initialPrice"
			onchange="document.getElementById('minimumPrice').min=this.value;"
			required /> <br>
		<br> <label for="minimumPrice">Minimum Selling Price:</label> <input
			type="number" step="0.01" min="0" name="minimumPrice"
			id="minimumPrice" /> <br>
		<br> <label for="bidIncrement">Minimum Bid Increment:</label> <input
			type="number" step="0.01" min="0" name="bidIncrement"
			id="bidIncrement" required /> <br>
		<br> <label for="endDate">Auction End Date:</label> <input
			type="datetime-local" name="endDate" id="endDate"
			onclick="setMinDate();" required /> <br>
		<br> <input type="submit" value="Post Item For Sale" />
	</form>
	<br>
